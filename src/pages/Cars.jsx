...
const Cars = () => {
  ...
  const getFilteredCars = () => {
    return cars
      .filter((car) => {
        ...
        return matchesSearch && matchesBrand && matchesFuel && matchesType && matchesSeats && matchesAvailable
      })
      .sort((a, b) => {
  ...
  <div className="col-12 col-lg-8 d-flex flex-column flex-lg-row justify-content-lg-end gap-2 mt-3 mt-lg-0">
    <div className="flex-grow-1 flex-lg-grow-0" style={{ minWidth: "250px" }}>
    ...
    <div>
      <Button variant="outline-primary" onClick={() => setFilterModalShow(true)}>
        <SlidersHorizontal size={16} className="me-2" />
        Filters{" "}
        {getActiveFiltersCount() > 0 && (
          <span className="badge bg-secondary ms-1">{getActiveFiltersCount()}</span>
        )}
      </Button>
    </div>
  </div>
      ...
      {filteredCars.length === 0 ? (
        ...
        <div className={`row ${viewMode === "list" ? "row-cols-1" : "row-cols-1 row-cols-md-2 row-cols-lg-3"}`}>
      ...
      <Modal show={filterModalShow} onHide={() => setFilterModalShow(false)} centered>
        <Modal.Header closeButton>
          <Modal.Title><SlidersHorizontal size={18} className="me-2" /> Filters</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div className="row g-3">
            ...
            <div className="col-12">
              <div className="form-check form-switch mt-2">
                ...
                />
                <label className="form-check-label ms-2 fw-semibold small" htmlFor="availableSwitch">
                  Available Only
                </label>
              </div>
            </div>
