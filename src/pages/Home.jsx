  ...
  const whyChooseUs = [
    {
      ...
      description: "Every detail matters. From vehicle maintenance to customer service, we deliver excellence.",
      stats: "99.8% Satisfaction",
    },
    {
      icon: <Heart size={28} className="text-danger" />,
      title: "Customer First",
      description: "Your experience is our priority. We go above and beyond to exceed expectations.",
      stats: "50K+ Happy Customers",
    },
    {
      icon: <ThumbsUp size={28} className="text-success" />,
      title: "Trusted Brand",
      description: "5 years of excellence in self-drive rentals with industry-leading safety standards.",
      stats: "5+ Years Experience",
    },
    {
      icon: <Compass size={28} className="text-warning" />,
      title: "Adventure Ready",
      description: "Whether it's business or leisure, our vehicles are equipped for every journey.",
    ...
    <div className="row align-items-center mb-4">
      <div className="col-12 col-lg-6 mb-4 mb-lg-0">
        ...
        <p className="text-muted mb-0 small">
          ...
          exceptional comfort, performance, and style for your perfect journey.
        </p>
      </div>
