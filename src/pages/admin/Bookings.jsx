...
const Bookings = () => {
  ...
  const [filters, setFilters] = useState({ search: "", status: "All", sort: "" });
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      case "Confirmed": return <CheckCircle size={18} color="green" />;
      case "Pending": return <Clock size={18} color="orange" />;
      case "Completed": return <Timer size={18} color="blue" />;
      case "Cancelled": return <XCircle size={18} color="red" />;
      default: return null;
    }
  };
  ...
  return (
    <div className="container py-4" style={{ minHeight: "700px" }}>
