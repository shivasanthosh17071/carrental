        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            ...
            <p className="text-light opacity-75 mb-4" style={{ lineHeight: "1.7" }}>
              Trusted since 2020, we offer 24/7 self-drive car rentals with
              doorstep delivery across Hyderabad. No accounts, no hidden terms—just pure driving freedom.
            </p>
          ...
          <div className="col-lg-2 col-md-6 mb-4">
            ...
            <ul className="list-unstyled">
              <li className="mb-3">
                <Link to="/" className="text-light opacity-75 text-decoration-none d-flex align-items-center">
                  <span className="me-2">→</span> Home
                </Link>
              </li>
              <li className="mb-3">
                <Link to="/cars" className="text-light opacity-75 text-decoration-none d-flex align-items-center">
                  <span className="me-2">→</span> Cars
                </Link>
              </li>
              <li className="mb-3">
                <Link to="/about" className="text-light opacity-75 text-decoration-none d-flex align-items-center">
                  <span className="me-2">→</span> About Us
                </Link>
              </li>
              <li className="mb-3">
                <Link to="/offers" className="text-light opacity-75 text-decoration-none d-flex align-items-center">
          ...
          <div className="col-lg-3 col-md-6 mb-4">
            ...
            <ul className="list-unstyled">
              <li className="mb-3 d-flex align-items-center text-light opacity-75">
                <Star size={16} className="text-warning me-2" fill="currentColor" />
          ...
          <div className="col-lg-3 col-md-6 mb-4">
            ...
            <div className="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <a href="tel:+919603879248" className="text-light opacity-75 text-decoration-none d-block">
                  +91 9603879248
                </a>
                <a href="tel:+917981592802" className="text-light opacity-75 text-decoration-none d-block">
                  +91 7981592802
                </a>
              </div>
            </div>
        ...
        <div className="row align-items-center">
          <div className="col-md-6">
            <p className="text-light opacity-75 mb-0 d-flex align-items-center">
              ...
              <Heart size={16} className="text-danger mx-2" fill="currentColor" />
