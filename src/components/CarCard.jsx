  ...
  return (
    ...
    >
      ...
      >
        {/* Image Section */}
        <div
          className={`position-relative ${viewMode === "list" ? "w-50" : ""}`}
          ...
          {viewMode === "grid" && (
            <>
              ...
              {/* <div className="position-absolute top-0 end-0 m-2">
                <button className="btn btn-sm bg-light border rounded-circle p-1 shadow-sm">
          ...
          {viewMode === "list" && (
            <div className="d-flex justify-content-between align-items-center mb-2">
              <div>
                ...
                <small className="text-muted">{car.brand} • {car.type}</small>
              </div>
              <span className={`badge fw-semibold small px-2 rounded-pill ${car.available ? "bg-success" : "bg-danger"}`}>
                {car.available ? "Available" : "Booked"}
              </span>
            </div>
          )}
